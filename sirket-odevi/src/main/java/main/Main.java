...
public class Main {
    public static void main(String[] args) {
        ...
        // Müdürler oluştur
        Mudur mudur1 = new Mudur("Ali", "Öztürk", "12345678901", 45000, "Yazılım", "Üst Düzey");
        Mudur mudur2 = new Mudur("Ayşe", "Demir", "12345678902", 30000, "İnsan Kaynakları", "Orta Düzey");
        
        // Çalışanlar oluştur
        Calisan calisan1 = new Calisan("Muhammet", "ak", "12345678903", 35000, "Yazılım");
        Calisan calisan2 = new Calisan("Aleyna", "çalışkan", "12345678904", 30000, "Yazılım");
        Calisan calisan3 = new Calisan("Ali", "beyaz", "12345678905", 13000, "İnsan Kaynakları");
